...
game.PlayerEntity = me.Entity.extend({
    init: function (x, y, settings) {
        ...
        // makes mario small in beggining
        this.big = false;
    ...
    update: function (delta) {
        ...
        //makes jump animation correspond with size of mario
        if (!this.big) {
    ...
    collideHandler: function (response) {
        ...
        if (response.b.type === 'badguy') {
            if (ydif <= -115) {
                ...
                //says if mario is big he will shrink and not 
                if (this.big) {
                    this.big = false;
